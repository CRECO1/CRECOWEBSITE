...
const REDIRECT_URI = 'https://www.crecotx.com/api/gmail/callback';
...
export async function GET(req: NextRequest) {
  ...
  if (error || !code || !userId) {
    return NextResponse.redirect('https://www.crecotx.com/crm?gmail=error');
  }
  ...
  return NextResponse.redirect('https://www.crecotx.com/crm?gmail=connected');
}
