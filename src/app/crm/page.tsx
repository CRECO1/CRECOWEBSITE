...
function LoginScreen({ onLogin }: { onLogin: (s: Session) => void }) {
  ...
  return (
    <div style={cardStyle}>
      <div style={boxStyle}>
        <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 22, fontWeight: 700, color: '#c9922c', marginBottom: 4 }}>CRECO</div>
        ...
        <form onSubmit={handleLogin}>
          ...
          <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@crecotx.com" required style={inputStyle} />
...
export default function CRMPage() {
  ...
  const loadProfile = useCallback(async () => {
    ...
    if (data) {
      ...
      const isAdmin = session.user.email === 'info@crecotx.com' ||
    ...
    <div style={{ fontFamily: "'DM Sans',sans-serif", display: 'flex', height: '100vh', overflow: 'hidden', background: '#f2f2f2' }}>
      ...
      <nav style={{ width: 248, background: '#111', display: 'flex', flexDirection: 'column', flexShrink: 0, overflowY: 'auto' }}>
        <div style={{ padding: '22px 20px 16px', borderBottom: '1px solid rgba(201,146,44,.3)' }}>
          <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 17, fontWeight: 700, color: '#c9922c', lineHeight: 1.2 }}>CRECO</div>
            ...
            <div style={{ padding: '22px 26px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 13 }}>
                {[
                  ...
                  { label: 'Email *', key: 'email', placeholder: 'agent@crecotx.com', type: 'email', full: true },
