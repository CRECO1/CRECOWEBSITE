    ...
    <CityHubPage
      config={{
        ...
        submarkets: [
          ...
          {
            name: 'The Heights & Inner Loop',
            characterization: 'Walkable retail + creative office',
            description: "Houston's urban-walkable commercial submarket. The Heights, Montrose, Rice Village — premium retail rents and growing creative office.",
            href: '/markets/houston-heights',
          },
          {
            name: 'Galleria / Uptown',
            characterization: 'Class A office + retail',
            description: "Houston's trophy office + premium retail core — Post Oak Boulevard, Williams Tower, the Galleria. Class A trophy holds; retail at Manhattan-like rents.",
            href: '/markets/galleria',
          },
          {
            name: 'Energy Corridor',
            characterization: 'Corporate office',
            description: 'I-10 West corporate office concentration. The most tenant-favorable Class A submarket in Texas — deep concessions, multi-year highs in TI and free rent.',
            href: '/markets/energy-corridor',
          },
          {
            name: 'The Woodlands',
            characterization: 'Corporate suburb + retail',
            description: "Master-planned commercial submarket — ExxonMobil campus, Hughes Landing trophy office, Town Center mixed-use retail. Top-tier demographics.",
            href: '/markets/the-woodlands',
          },
          {
            name: 'Sugar Land',
            characterization: 'Office + retail + medical',
            description: 'Southwest Houston\'s corporate-office, retail, and medical center. Town Square, First Colony, and the Memorial Hermann corridor anchor.',
            href: '/markets/sugar-land',
          },
        ],
        whyBullets: [
