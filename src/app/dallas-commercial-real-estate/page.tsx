    ...
    <CityHubPage
      config={{
        ...
        marketIntro: [
          ...
          "CRECO's DFW practice covers tenant rep, owner services, and investment advisory across the Metroplex. From our San Antonio headquarters we work with a network of DFW-based brokers, attorneys, lenders, contractors, and capital partners that we've built through years of cross-Texas activity. The depth of the market means our work focuses on filtering rapidly, running competitive processes, and using the breadth of available options as negotiating leverage.",
        ],
        servicesIntro: [
