...
export const CAPABILITIES: { name: string; serviceType: string; description: string; url?: string }[] = [
  ...
  { name: 'Landlord / owner representation', serviceType: 'Landlord representation', description: 'Leases and markets commercial property for landlords and owners — listing, marketing, tenant sourcing, and lease negotiation.', url: '/landlord-representation' },
  { name: 'Investment sales', serviceType: 'Investment sales brokerage', description: 'Sells and acquires commercial investment property for owners and investors, including 1031 exchange replacement property.', url: '/seller-investor-representation' },
  { name: 'Buyer representation', serviceType: 'Buyer representation', description: 'Represents owner-users and investors buying commercial property and land.', url: '/seller-investor-representation' },
...
export const BUSINESS = {
  ...
  streetAddress: '8000 Fair Oaks Pkwy, Suite 101',
  locality: 'Fair Oaks Ranch',
  region: 'TX',
  postalCode: '78015',
  country: 'US',
  fullAddress: '8000 Fair Oaks Pkwy, Suite 101, Fair Oaks Ranch, TX 78015',
  latitude: 29.734008,
  longitude: -98.643139,
